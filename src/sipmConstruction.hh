#ifndef __RAT_sipmConstruction__
#define __RAT_sipmConstruction__
...
struct sipmConstructionParams {
  sipmConstructionParams() {
...
class sipmConstruction : public PMTConstruction {
 public:
  sipmConstruction(DBLinkPtr params, G4LogicalVolume *mother);
  virtual ~sipmConstruction() {}
 ...
 protected:
  ...
  sipmConstructionParams fParams;
};
